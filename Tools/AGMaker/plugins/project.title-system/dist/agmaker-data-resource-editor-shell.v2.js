...
(() => {
  ...
  if (config.shellVersion !== 2 || !Array.isArray(config.resources) || config.resources.length === 0) throw new Error('DataResource Editor Shell 配置无效');
  ...
  style.textContent = ':root{color-scheme:dark;font-family:Inter,system-ui,"Microsoft YaHei",sans-serif;background:#080d18;color:#eef3ff}*{box-sizing:border-box}html,body,#agmaker-editor-root{min-height:100vh}body{margin:0;min-width:320px;background:radial-gradient(circle at 88% -12%,#22365b 0,transparent 34%),#080d18}header{min-height:72px;padding:12px 22px;display:flex;align-items:center;gap:18px;justify-content:space-between;border-bottom:1px solid #263956;background:rgba(13,21,36,.96);box-shadow:0 12px 28px rgba(0,0,0,.18)}h1{font-size:19px;margin:0;letter-spacing:.01em}.resource-switch{min-width:156px;padding:9px 11px;border:1px solid #405a80;border-radius:8px;background:#111d31;color:#fff}.shell{display:grid;grid-template-columns:minmax(278px,31%) minmax(0,1fr);height:calc(100vh - 72px);max-width:1680px;margin:0 auto}aside{border-right:1px solid #263956;padding:16px 14px;overflow:auto;background:rgba(10,17,30,.72)}.list-header{display:flex;align-items:center;gap:7px}.search{width:100%;min-width:0;padding:10px 12px;border:1px solid #344d70;border-radius:8px;background:#0d1729;color:#fff;outline:none}.search:focus,input:focus,textarea:focus,select:focus{border-color:#8f78ff;box-shadow:0 0 0 3px rgba(143,120,255,.16)}.list{display:grid;gap:7px;margin-top:12px}.record{width:100%;padding:11px 12px;text-align:left;border:1px solid #1f314b;border-radius:10px;background:linear-gradient(135deg,#121f34,#101a2c);color:#cdd8eb;cursor:pointer;transition:border-color .16s,transform .16s,background .16s}.record:hover{border-color:#496993;transform:translateY(-1px)}.record[aria-current="true"]{border-color:#937cff;background:linear-gradient(135deg,#2a2851,#1a2944);box-shadow:0 6px 18px rgba(88,70,190,.22)}.detail{padding:28px clamp(20px,3vw,42px);overflow:auto}.detail::before{content:"";display:block;height:1px;background:linear-gradient(90deg,#705ae8,transparent);margin-bottom:18px;opacity:.72}form{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:16px;padding:18px;border:1px solid #233a58;border-radius:14px;background:rgba(13,23,40,.86);box-shadow:0 16px 30px rgba(0,0,0,.13)}label{display:grid;gap:7px;color:#c1d0e7;font-size:12px;font-weight:600;letter-spacing:.01em}input,textarea,select{padding:10px 11px;border:1px solid #344d70;border-radius:8px;background:#0a1425;color:#f2f6ff;font:inherit}textarea{min-height:112px;resize:vertical}label:has(textarea){grid-column:1/-1}.actions{display:flex;gap:9px;flex-wrap:wrap;margin:18px 0}button{padding:9px 14px;border:1px solid #45618a;border-radius:8px;background:#21375a;color:#f1f5ff;cursor:pointer;font-weight:600}button:hover:not(:disabled){background:#2a4775}button:disabled{opacity:.45;cursor:not-allowed}.actions [data-crud-operation="update"]{background:linear-gradient(135deg,#6856d6,#8d73ec);border-color:#9a85f4}.danger{border-color:#8c4d61;background:#432433}.status{min-height:48px;padding:12px 14px;border:1px solid #263f60;border-radius:10px;background:#0c1729;color:#b8c8df;white-space:pre-wrap}.empty{padding:34px 10px;color:#8ca0bb;text-align:center}@media(max-width:720px){header{align-items:flex-start;flex-direction:column}.shell{grid-template-columns:1fr;height:auto}aside{border-right:0;border-bottom:1px solid #263956}form{grid-template-columns:1fr}.detail{padding:20px 14px}label:has(textarea){grid-column:auto}}';
